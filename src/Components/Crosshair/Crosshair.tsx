...
import type { CrosshairDispatch, CrosshairState } from "../../Redux/Store";

export const Crosshair = () => {
  const crosshairState = useSelector(
    (state: CrosshairState) => state.crosshair,
  );
  const dispatch = useDispatch<CrosshairDispatch>();
